...
$dan=array(
    ...
    'map'=>array('tip'=>'ftext','name'=>'Карта','r'=>1,'w'=>1,'group'=>'Карта'),
   // 'text_ua'=>array('tip'=>'ftext','name'=>'Текст ua','r'=>1,'w'=>1),
    
      'tel'=>array('tip'=>'text','name'=>'Телефон ','r'=>1,'w'=>1,'ob'=>1,'group'=>'Филиал'),
    'adr'=>array('tip'=>'btext','name'=>'Адрес','r'=>1,'w'=>1,'group'=>'Филиал'),
    'icq'=>array('tip'=>'text','name'=>'ICQ','r'=>1,'w'=>1,'group'=>'Филиал'),

    'email'=>array('tip'=>'email','name'=>'Email','r'=>1,'w'=>1,'ob'=>1,'group'=>'Филиал'),
...
$admin_center_area.=tab_admin('contacts','Контакты',$dan,$dan1);
?>
