...
$dan1=array(
   ...
   // 'sort'=>0, // включть сортировку   
    ...
    $admin_center_area.=tab_admin('hara_gal','Портфолио (мета данные)',$dan,$dan1);
    
    
    $dan=array(
    'id'=>array('tip'=>'id','name'=>'id','r'=>0),
        
    'img'=>array('tip'=>'img','name'=>'Картинка','r'=>1,'w'=>1,'path'=>'/img/hara_gal/','imgw'=>900),
...
$dan1=array(
   ...
   // 'sort'=>0, // включть сортировку   
    ...
    $admin_center_area.=tab_admin('hara_gal_im','Портфолио',$dan,$dan1);
