...
$sel=$db->select("SELECT * FROM ".DB_PREFIX."hara_fund WHERE en=1 ");
if ($sel){
...
$gal='';
if (!empty($sel['img_m'])){
$imgs=$db->select("SELECT * FROM ".DB_PREFIX."hara_fund_img WHERE pid = ".$sel['id']."");
...
$center_area=showtempl(dirname(__FILE__).'/templ/tpl_fund.php');
}
else $_GET['error']=404;
