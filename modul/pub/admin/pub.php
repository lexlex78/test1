...
$dan=array(
    ...
    'img'=>array('tip'=>'img','name'=>'Картинка','r'=>1,'w'=>1,'path'=>'/img/pub/','imgw'=>190,/*'imgh'=>252 */),
    'data'=>array('tip'=>'datatime','name'=>'Дата','r'=>1,'w'=>1,'ob'=>1,'def'=>date('Y-m-d H:i')),
    'mnenie'=>array('tip'=>'bool','name'=>'Мнение','r'=>1,'w'=>1,'def'=>0),
...
$admin_center_area.=tab_admin('pub','Публикации',$dan,$dan1);
