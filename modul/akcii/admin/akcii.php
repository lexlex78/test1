...
$dan=array(
    ...
    'img'=>array('tip'=>'img','name'=>'Картинка','r'=>1,'w'=>1,'path'=>'/img/akcii/','imgw'=>190,/*'imgh'=>252 */),
    'data'=>array('tip'=>'data','name'=>'Дата от','r'=>1,'w'=>1,'ob'=>1,'def'=>date('Y-m-d')),
    'data_to'=>array('tip'=>'data','name'=>'Дата до','r'=>1,'w'=>1,'ob'=>1,'def'=>date('Y-m-d')),
...
$admin_center_area.=tab_admin('akcii','Акции',$dan,$dan1);
