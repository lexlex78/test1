...
$dan=array(
    ...
    'img'=>array('tip'=>'img','name'=>'Картинка','r'=>1,'w'=>1,'path'=>'/img/article/','imgw'=>190,/*'imgh'=>252 */),
 ...
 //  'soput'=>array('tip'=>'sel_tabm','name'=>'Новости по теме','r'=>0,'w'=>1,'tabl'=>'article','td'=>'zag_ru'),
...
$admin_center_area.=tab_admin('article','Статьи/Обзоры',$dan,$dan1);
